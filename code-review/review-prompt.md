...
checkout (the working tree), and a checkout of the merge-base (the pre-change state).
Read-only reference checkouts of related repositories, when configured, are described
